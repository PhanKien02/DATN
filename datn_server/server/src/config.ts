...
export class Config {
    debugLogging = 'debug';
    'server.port' = '8081';
    'jhipster.clientApp.name' = 'DATN_Server';
    ...
    'jhipster.mail.from' = 'DATN_Server@localhost';
    'jhipster.swagger.default-include-pattern' = '/api/.*';
    'jhipster.swagger.title' = 'DATN_Server API';
    'jhipster.swagger.description' = 'DATN_Server API documentation';
    ...
    'eureka.instance.appname' = 'DATN_Server';
    'eureka.instance.instanceId' = 'DATN_Server:${random.value}';
