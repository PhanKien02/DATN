...
describe('District Controller', () => {
    ...
    it('/GET all districts ', async () => {
        ...
        const getEntities: DistrictDTO[] = (await request(app.getHttpServer())
        .get('/api/districts')
        .expect(200)).body;
    ...
    it('/GET districts by id', async () => {
        ...
        const getEntity: DistrictDTO = (await request(app.getHttpServer())
    ...
    it('/POST create districts', async () => {
        ...
        const createdEntity: DistrictDTO = (await request(app.getHttpServer())
            .post('/api/districts')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update districts', async () => {
        ...
        const updatedEntity: DistrictDTO = (await request(app.getHttpServer())
            .put('/api/districts')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update districts from id', async () => {
        ...
        const updatedEntity: DistrictDTO = (await request(app.getHttpServer())
            .put('/api/districts/' + entityMock.id)
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE districts', async () => {
        ...
        const deletedEntity: DistrictDTO = (await request(app.getHttpServer())
