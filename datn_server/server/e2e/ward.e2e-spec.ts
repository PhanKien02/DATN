...
describe('Ward Controller', () => {
    ...
    it('/GET all wards ', async () => {
        ...
        const getEntities: WardDTO[] = (await request(app.getHttpServer())
        .get('/api/wards')
        .expect(200)).body;
    ...
    it('/GET wards by id', async () => {
        ...
        const getEntity: WardDTO = (await request(app.getHttpServer())
    ...
    it('/POST create wards', async () => {
        ...
        const createdEntity: WardDTO = (await request(app.getHttpServer())
            .post('/api/wards')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/PUT update wards', async () => {
        ...
        const updatedEntity: WardDTO = (await request(app.getHttpServer())
            .put('/api/wards')
            .send(entityMock)
            .expect(201)).body;
    ...
    it('/DELETE wards', async () => {
        ...
        const deletedEntity: WardDTO = (await request(app.getHttpServer())
